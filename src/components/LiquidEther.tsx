...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    console.log('LiquidEther useEffect started', mountRef.current);
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        this.container = container;
        // Listen to global mouse movements, not just within container
...
`;
    ...
    console.log('WebGL manager created, starting...', webgl);
    webgl.start();
    console.log('WebGL started successfully');
